...
class OrderModel {
  String? id,
      ...
      invoice,
      delDate,
      delTime,drivername,driverfuid,driveremail,driverfcm,sellername,sellerfcm,selleremail,sellerfuid;
  ...
  OrderModel(
      ...
      this.delTime,
      this.deliveryBoyId,
      this.attachList,this.drivername,this.driveremail,this.driverfcm,this.driverfuid,this.sellername,this.sellerfuid,this.selleremail,this.sellerfcm});
