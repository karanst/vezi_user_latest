...
class Product {
  ...
  List<String>? selectedId = [];
  List<String>? tagList = [];
  int? minOrderQuntity,openCloseStatus;
  String? isFav,
      isReturnable,
      isCancelable,
      isPurchased,
...
String?  store_description,
    ...
    seller_name,
    seller_id,
    store_name,latitude,longitude,delivery_tiem,category_ids;
  ...
  Product(
      ...
      this.gurantee,
        ...
        this.seller_name,
        this.seller_id,
        this.store_name,this.latitude,this.longitude,this.delivery_tiem,
        this.category_ids
      });
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    List<String> other_image =[];

    if(json[OTHER_IMAGE]!=null){
     other_image = List<String>.from(json[OTHER_IMAGE]);
    ...
    return Product(
      ...
      delivery_tiem: json["delivery_tiem"],
