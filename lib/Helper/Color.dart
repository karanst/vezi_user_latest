...
extension colors on ColorScheme {
  ...
  static const Color secondary = Color(0xffFE7902);
  ...
  static const Color grad1Color = Color(0xffFE7902);
  static var grad2Color = Color(0xffFE7902);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xffFE7902);
