...
final Uri getHealthCatApi = Uri.parse(baseUrl + 'get_health_wellness');
final Uri getSliderApi = Uri.parse(baseUrl + 'get_slider_images');
final Uri getSecondSliderApi = Uri.parse(baseUrl + 'get_secound_slider');
final Uri getThirdSliderApi = Uri.parse(baseUrl + 'get_third_slider');
final Uri getCityApi = Uri.parse(baseUrl + 'get_location');
final Uri getCatApi = Uri.parse(baseUrl + 'get_categories');
final Uri getSubCatBySellerId = Uri.parse(baseUrl + 'get_subcategory');
...
final Uri getRestApi = Uri.parse(baseUrl + 'get_restaurants');
final Uri getRestProductApi = Uri.parse(baseUrl + 'get_restaurants_product');
final Uri getFeatureProductApi = Uri.parse(baseUrl + 'get_features_product');
final Uri bookFeatureProductApi = Uri.parse(baseUrl + 'Booking_order');
...
final Uri getPharmacyOrderApi = Uri.parse(baseUrl + 'get_prescription');
final Uri getFeatureOrderApi = Uri.parse(baseUrl + 'get_booking_order');
...
const String LANDMARK = 'Flat no, Floor, Landmark';
