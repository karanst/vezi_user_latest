    ...
    if (price != 0) {
      ...
      return Padding(
        ...
        child: Row(
          children: <Widget>[
            Text(
             widget.model!.prVarientList![pos].price! + " " + CUR_CURRENCY!,
                    ...
                    children: [
                      ...
                      Text(
                        double.parse(productList[index]
                                    ...
                                    .disPrice!) !=
                                0
                            ? productList[index].prVarientList![0].price! + " " + CUR_CURRENCY!
                            : "",
    ...
    return Card(
      ...
      child: GestureDetector(
        child: ListTile(
          ...
          trailing:widget.model!.madein == null || widget.model!.madein  == ""? SizedBox.shrink():Text("${widget.model!.madein}")
        ),
