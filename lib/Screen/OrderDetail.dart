...
//                     Text(" ${widget.model!.payable!}" + "" + CUR_CURRENCY!,
//                         style: Theme.of(context).textTheme.button!.copyWith(
//                             color: Theme.of(context).colorScheme.lightBlack2))
//                   ],
//                 ),
...
//                     //     crossAxisAlignment: CrossAxisAlignment.start,
//                     //     children: [
//                     //       pDate != null ? getPlaced(pDate[0]) : getPlaced(aDate!),
//                     //       getProcessed(prDate, cDate),
//                     //       getShipped(sDate, cDate),
//                     //       getDelivered(dDate, cDate),
//                     //       getCanceled(cDate),
//                     //       getReturned(orDetail!, rDate, model),
//                     //     ],
//                     //   ),
//                     // ),
//                   ],
...
//   }
//
//   storeDetails(OrderItem orderItem, OrderModel model) {
//     return Card(
//       elevation: 0,
//       child: Padding(
...
//                       ),
//
//                       vendorChat=="0"?model.sellerfuid!=""&&model.sellerfuid!=null&&model.sellerfuid!="0"?Padding(
//                         padding: const EdgeInsets.only(left: 8.0),
//                         child: Align(
//                             alignment: Alignment.bottomRight,
//                             child: OutlinedButton(
...
//                                 sellerFcm = model.sellerfcm.toString();
//                                 callChatSeller();
//                               },
//                               child: Text(getTranslated(context, 'CHAT')!),
//                             )),
//                       ):SizedBox():SizedBox(),
//                     ],
//                   ),
...
//                     children: [
//                       Text(
//                         model.drivername!=null?"${model.drivername} ":"Not Assign",
//                         style: TextStyle(
//                           color: Theme.of(context).colorScheme.lightBlack2,
//                         ),
//                       ),
//                       driverChat=="0"?model.driverfuid!=""&&model.driverfuid!=null&&model.driverfuid!="0"?Padding(
//                         padding: const EdgeInsets.only(left: 8.0),
//                         child: Align(
//                             alignment: Alignment.bottomRight,
//                             child: OutlinedButton(
...
//                                 driverFcm = model.driverfcm.toString();
//                                 callChat();
//                                 /* Navigator.push(
//
//                                   context,
...
//   }
//
//   String sellerEmail = "", driverEmail = "test123@gmail.com",driverFid="",driverFcm="";
//   String sellerName = "", driverName = "Test Boy",sellerFid="",sellerFcm="";
...
//       );
//       print("test");
//       _handlePressed(otherUser1,driverFcm);
//     }
//   }
...
//         lastName: "",
//       );
//       _handlePressed(otherUser1,sellerFcm);
//     }
//   }
//   _handlePressed(types.User otherUser,String driverFcm) async {
