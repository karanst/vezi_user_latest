...
import 'package:vezi/Model/paydata.dart';
...
class StateCart extends State<Cart> with TickerProviderStateMixin {
  ...
  _initiateCcAvenuePayment(String orderId) async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse('${UrlList.merchant_server_enc_url}?order_id=$orderId'));
          // .post(Uri.parse(UrlList.merchant_server_enc_url),
          // body: {"amount": amount});

      print("ccavenue requesrt is ${UrlList.merchant_server_enc_url}?order_id=$orderId &&& ${response.body}");
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                   cartList[index].perItemTotal! + " " + CUR_CURRENCY! ,
                  style: TextStyle(
                      color: Theme.of(context).colorScheme.lightBlack2),
                )
              ],
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                        ...
                                        " ${oriPrice.toStringAsFixed(2)}"  + " " + CUR_CURRENCY!,
                                    style: Theme.of(context)
                                        .textTheme
                                        .subtitle1!
                                        .copyWith(
                              ...
                              isPromoValid!
                                  ? Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                              promoAmt.toString() + " " + CUR_CURRENCY! ,
                                          style: Theme.of(context)
                                              .textTheme
                                              .caption!
                                              .copyWith(
                                        ...
                                        child: Row(children: <Widget>[
                                          Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                        " ${totalPrice.toStringAsFixed(2)}" + " "  + CUR_CURRENCY!,
                                                    style: TextStyle(
                                                        color: Theme.of(context)
                                                            .colorScheme
                                                            .fontColor,
        ...
        if (response.statusCode == 200) {
          ...
          if (!error) {
            ...
            if (payMethod == getTranslated(context, 'RAZORPAY_LBL')) {
              ...
              _initiateCcAvenuePayment(orderId);
              // addTransaction(tranId, orderId, SUCCESS, msg, true);
            }
            else {
              ...
              isPromoValid!
                  ? Row(
                      ...
                      children: [
                        ...
                        Text(
                          promoAmt.toStringAsFixed(2) + " " + CUR_CURRENCY!,
                          style: TextStyle(
                              color: Theme.of(context).colorScheme.fontColor,
                              fontWeight: FontWeight.bold),
                        )
              ...
              isUseWallet!
                  ? Row(
                      ...
                      children: [
                        ...
                        Text(
                          usedBal.toStringAsFixed(2) + " " + CUR_CURRENCY!,
                          style: TextStyle(
                              color: Theme.of(context).colorScheme.fontColor,
                              fontWeight: FontWeight.bold),
                        )
