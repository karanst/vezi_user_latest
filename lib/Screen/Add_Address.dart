...
class StateAddress extends State<AddAddress> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    deliverAddressC = TextEditingController();
    ...
    if (widget.update!) {
      ...
      deliverAddressC!.text = item.deliveryAddress!;
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon:
                          const Icon(Icons.search, color: colors.primary, size: 17),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => PlacePicker(
                              ...
                              initialPosition: LatLng(double.parse(latitudeHome.toString()), double.parse(longitudeHome.toString())),
